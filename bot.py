...
def reply(message):
		...
		if "hi"==text.lower() or "hello"==text.lower() or "namaste"==text.lower() or "hola"==text.lower():
			...
			if reply_type=="text":
				...
				cap_entities = message.reply_to_message.json["caption_entities"]
...
API_TOKEN = '1532672197:AAGBrhsDRQl5LLOch3bzqwka9AxKbIkrYDk'

WEBHOOK_HOST = 'chatbotbysai.herokuapp.com/'
