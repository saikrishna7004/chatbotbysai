...
names = {
	...
	'cycle' : ['0',
			   'BQACAgQAAxkBAAITgGAXmoKxshHzzBPZgW17J_qoCHpBAAKrFQAC5LwYUOOTtsgGQDWWHgQ',
			   'BQACAgQAAxkBAAITgWAXmoJ_Ka-fYIqnV_MAAdkHAaNzlQAC2AgAAvAtGFBr9q8UNVEeyx4E',
			   '0',
			   'BQACAgQAAxkBAAITgmAXmoJOCxJ1T0xMVv8W4aYGAiEdAAL8CAACUy4ZUHUGBUr0ODRTHgQ',
			   'Cycle 2021 Telugu DVDRip'
	],
	...
	'guvvagorinka'  :
			 ['BQACAgQAAxkBAAITtmAXrjTuEfk2wE5lkupDJjV6B9EUAAJzCQACcijYUifpZKE6Ri4aHgQ',
			  'BQACAgQAAxkBAAITt2AXrjTy44YjwAABn8JKeHckngZYmAACeQkAAnIo2FI7mPiEtIjhrx4E',
			  'BQACAgQAAxkBAAITuGAXrjQGSzKNT_u-LNvaomf9edpOAAJ0CQACcijYUocS7hO5ei8oHgQ',
			  'BQACAgQAAxkBAAITuWAXrjTPTg5-YHEx7R6yXzFSiRx5AAJ2CQACcijYUnPOfP_WjJGWHgQ',
			  '0',
			  'Guvva Gorinka 2021 Telugu HDRip'
	],
...
key = {
		  "inline_keyboard": [
						...
						[
							{"text": "Guvva Gorinka", "callback_data": "m8"},
						],
						[
...
c = types.InlineKeyboardButton(text="Cycle", callback_data="m3")
...
h = types.InlineKeyboardButton(text="Guvva Gorinka", callback_data="m8")
